...
\begin{document}
  ...
  \begin{figure}[h!]
    ...
    \caption{Membuat VM 3 a}
  \end{figure}
  \begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\linewidth]{create vm 3 b.png}
    \caption{Membuat VM 3 b}
  \end{figure}
  \newpage
  \begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\linewidth]{create vm 3 c.png}
    \caption{Membuat VM 3 c}
  \end{figure}
  \item Untuk bagian ini langsung tekan Next.
  \begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\linewidth]{create vm 4.png}
    \caption{Membuat VM 4}
  \end{figure}
  \newpage
  \item Jika ingin mengubah ukuran pemnyimpanan pada VM atur pada menu Disk size (GiB).
  \begin{figure}[h!]
    \centering
